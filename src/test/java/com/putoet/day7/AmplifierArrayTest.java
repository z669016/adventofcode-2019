...
class AmplifierArrayTest {
    ...
    @Test
    void sample1Part1() {
        final List<Integer> intCodeProgram = List.of(3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0);
    ...
    @Test
    void sample2Part1() {
        final List<Integer> intCodeProgram = List.of(3, 23, 3, 24, 1002, 24, 10, 24, 1002, 23, -1, 23,
    ...
    @Test
    void sample3Part1() {
        final List<Integer> intCodeProgram = List.of(3,31,3,32,1002,32,10,32,1001,31,-2,31,1007,31,0,33,
    ...
    @Test
    void sample1Part2() {
        final List<Integer> intCodeProgram = List.of(3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,
    ...
    @Test
    void sample2Part2() {
        final List<Integer> intCodeProgram = List.of(3,52,1001,52,-5,52,3,53,1,52,56,54,1007,54,5,55,1005,55,26,1001,54,
