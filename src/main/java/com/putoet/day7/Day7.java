...
public class Day7 {
    public static void main(String[] args) throws IOException {
        ...
        // Part one
        final List<List<Integer>> sequences = new Permutator<Integer>().permute(List.of(0, 1, 2, 3, 4));

        final Integer max = sequences.stream().map(sequence -> {
        ...
        System.out.println("Available output for is " + max);
    }
}
